                ...
                <div class="table-responsive">
                    <table class="table table-hover ">
						...
						<tr>
                            ...
                            <td>
                                <a href="/typeDetail?typeId=${item.typeId}" class="label xiugai">
                                    <span class="glyphicon glyphicon-edit"></span> 查看</a>
                                <a href="/typeEdit?typeId=${item.typeId}" class="label xiugai">
                                    <span class="glyphicon glyphicon-edit"></span> 修改</a>
                                <a href="/typeDelete?typeId=${item.typeId}" onclick="{return confirm('删除该记录将不能恢复，确定删除吗？');};"
