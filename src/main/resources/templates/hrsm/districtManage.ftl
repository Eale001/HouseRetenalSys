    ...
    <div class="col-md-12 thistable">
        ...
        <div class="bgc-w box box-primary">
            ...
            <div class="box-header">
                <h3 class="box-title">
                    <a href="/districtSave" class="label label-success" style="padding: 5px;">
                ...
                <div class="table-responsive">
                    <table class="table table-hover ">
                        <tr>
                            ...
                            <th scope="col">街区名称</th>
                            <th scope="col">所属地区</th>
                            <th scope="col">录入人员</th>
                            <th scope="col">录入时间</th>
                            <th scope="col">操作</th>
                        </tr>
						<#list districtAll as item>
						<tr>
                            <td><span>${(item.disName)!''}</span></td>
                            <td><span>${(item.region.regionName)!''}</span></td>
                            ...
                            <td>
                                <a href="/districtDetail?districtId=${item.districtId}" class="label xiugai">
                                    <span class="glyphicon glyphicon-edit"></span> 查看</a>
                                <a href="/districtEdit?districtId=${item.districtId}" class="label xiugai">
                                    <span class="glyphicon glyphicon-edit"></span> 修改</a>
                                <a href="/districtDelete?districtId=${item.districtId}" onclick="{return confirm('删除该记录将不能恢复，确定删除吗？');};"
