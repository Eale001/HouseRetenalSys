...
<div class="row" style="padding-top: 15px;">
    <div class="col-md-12">
        ...
        <div class="bgc-w box">
            ...
            <!--盒子身体-->
            <form action="/districtSave" method="post" onsubmit="return check();">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label>
                                    <span id="ctl00_cphMain_Label1">街道名称</span>
                                </label>
                                <input name="disName" type="text" value="${(district.disName)!''}" class="form-control" readonly/>
                                <input name="districtId" type="text" value="${(district.districtId)!''}" hidden="hidden"/>
                            </div>
