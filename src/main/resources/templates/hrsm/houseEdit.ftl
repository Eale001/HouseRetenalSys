                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input name="title" type="text" value="${(house.title)!''}" class="form-control"/>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input name="area" type="text" value="${(house.area)!''}" class="form-control"/>
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input name="price" type="text" value="${(house.price)!''}" class="form-control"/>
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input name="phone" type="text" value="${(house.phone)!''}" class="form-control"/>
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input name="contacts" type="text" value="${(house.contacts)!''}" class="form-control"/>
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input name="discription" type="text" value="${(house.discription)!''}" class="form-control"/>
                            </div>
